...
*   [SiYuan plugin sample (Vite & Vue3)](https://github.com/siyuan-note/siyuan-flashcard-title-toolbox-plugin) - 基于 Vite 和 Vue3 的模板，由本文作者主要维护

你可以在其中挑选一个，用于创建你自己的插件。

由于本篇是扫盲贴，面向的是没经验的小白，因此推荐首选 `[siyuan-flashcard-title-toolbox-plugin](https://github.com/siyuan-note/siyuan-flashcard-title-toolbox-plugin)` 这个模板，次选 `[plugin-sample-vite-svelte](https://github.com/siyuan-note/plugin-sample-vite-svelte)` 这个模板。
...
本小节主要是给不懂使用 GitHub 等技术的小白，进一步解释 [siyuan-note/siyuan-flashcard-title-toolbox-plugin - README_zh_CN# 开始](https://github.com/siyuan-note/siyuan-flashcard-title-toolbox-plugin/blob/main/README_zh_CN.md#%E5%BC%80%E5%A7%8B) 中的操作。
...
4、打开 `思源 - 设置 - 集市` 中，即可看到名为 `siyuan-flashcard-title-toolbox-plugin` 的插件。
